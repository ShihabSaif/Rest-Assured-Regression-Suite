...
import com.example.restassuredproject.DTO.RocketCashOutBodyParams;
...
public class RocketCashOut {
    public Response rocketCashOut(User user) throws IOException {
        RestAssured.baseURI= APIPath.tallypay_to_fi_producer;
        RocketCashOutBodyParams cashout = new RocketCashOutBodyParams();
